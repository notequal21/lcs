...
const swiper3 = new Swiper('.project-slider', {
    ...
    navigation: {
        nextEl: '.projectmob-button-next',
        prevEl: '.projectmob-button-prev',
    },
    pagination: {
        el: '.swiper2-pagination',
        clickable: true,
...
const swiper4 = new Swiper('.clients-slider', {
    spaceBetween: 10,
    slidesPerView: 'auto',
    loop: true,
    breakpoints: {
...
const swiper5 = new Swiper('.how-slider', {
    spaceBetween: 0,
    slidesPerView: 1,
    centeredSlides: true,
    loop: false,
    autoHeight: true,
    navigation: {
        nextEl: '.howmob-button-next',
        prevEl: '.howmob-button-prev',
    },
});


$(document).ready(function(){
    $('.faq-body__spoiler-title').click(function(event) {
        if($('.faq-body__spoilers').hasClass('one')){
            $('.faq-body__spoiler-title').not($(this)).removeClass('active');
            $('.faq-body__spoiler-content').not($(this).next()).slideUp(300);
        }
...
if (document.querySelector('.popup')) {
    ...
    let btnOpen = document.querySelectorAll('.popup__btn');
    let btnClose = document.querySelector('.policy__close');
    let popup = document.querySelector('.popup');
    let popupBg = document.querySelector('.popup-bg');

    let getItemAtr = (index) => {
        let itemName = `smartpay services (popup= ${index} )`; 
        document.querySelector('#popup-sub').value = itemName;
    }
        ...
        if (popup.classList.contains('active')) {
            ...
            if (document.querySelector('.services')) {
                window.addEventListener('click', function(e) {
                    // console.log(e.target.getAttribute('data-cardname'));
                    if (e.target.classList.contains('services-content__item-btn')) {
                        getItemAtr(e.target.getAttribute('data-cardname'));
                    }
                })
                // getItemAtr(0);
            }
    ...
    btnOpen.forEach((item) => {
        ...
        // itemNames.push(item.getAttribute('data-cardname'));
    });
...
if (document.querySelector('.popup-call')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
    let btnOpen = document.querySelectorAll('.popup-call__btn');
    let btnClose = document.querySelector('.policy-call__close');
    let popup = document.querySelector('.popup-call');
    let popupBg = document.querySelector('.popup-call-bg');
...
if (document.querySelector('.popup-order')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
    let btnOpen = document.querySelectorAll('.popup-order__btn');
    let btnClose = document.querySelector('.policy-order__close');
    let popup = document.querySelector('.popup-order');
    let popupBg = document.querySelector('.popup-order-bg');
...
if (document.querySelector('.popup-get')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
    let btnOpen = document.querySelectorAll('.popup-get__btn');
    let btnClose = document.querySelector('.policy-get__close');
    let popup = document.querySelector('.popup-get');
    let popupBg = document.querySelector('.popup-get-bg');

    let getItemAtr = (index) => {
        let itemName = `${index}`; 
        document.querySelector('#popup-sub-get').value = itemName;
    }
    ...
    let popupOpen = () => {
        ...
        if (popup.classList.contains('active')) {
            ...
            if (document.querySelector('.form-get')) {
                window.addEventListener('click', function(e) {
                    // console.log(e.target.getAttribute('data-cardname'));
                    // console.log(e.target);
                    if (e.target.classList.contains('popup-get__btn')) {
                        getItemAtr(e.target.getAttribute('data-cardname'));
                    }
                })
                // getItemAtr(0);
...
if (document.querySelector('.popup-project')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
    let btnOpen = document.querySelectorAll('.popup-project__btn');
    let btnClose = document.querySelector('.policy-project__close');
    let popup = document.querySelector('.popup-project');
    let popupBg = document.querySelector('.popup-project-bg');

    let getItemAtr = (imgSrc, projectInfo) => {  
        document.querySelector('#popup-project-img').src = `${imgSrc}.png`;
        document.querySelector('#popup-project-img').srcset = `${imgSrc}.png 1x, ${imgSrc}@2x.png 2x`;
        document.querySelector('#popup-project-info').innerHTML = projectInfo;
    }
    ...
    let popupOpen = () => {
        ...
        if (popup.classList.contains('active')) {
            ...
            window.addEventListener('click', function(e) {
                // console.log(e.target.getAttribute('data-cardname'));
                // console.log(e.target);
                if (e.target.classList.contains('popup-project__btn')) {
                    // console.log(getItemAtr(e.target));
                    getItemAtr(e.target.getAttribute('data-imgsrc'), e.target.getAttribute('data-projectinfo'));
                }
            })
            popup.classList.add('active');
            document.querySelector('body').classList.add('lock');
...
if (document.querySelector('.thanks-popup')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
    // let btnOpen = document.querySelectorAll('.popup-get__btn');
    let btnClose = document.querySelector('.policy-thx__close');
    let popup = document.querySelector('.thanks-popup');
    let popupBg = document.querySelector('.popup-thx-bg');
...
// if (document.querySelector('.thanks-popup')) {
    // let btnOpen = document.querySelectorAll('.services-content__item-btn');
//     let thanks = document.querySelector('.thanks-popup');
//     let thanksBg = document.querySelector('.thanks-popup__bg');
//     let thankClose = document.querySelector('.policy-thx__close')
...
//         }
//     }
//     thanksBg.addEventListener('click', thanksClose);
// }
/*!
...
$(document).ready(function(){   
    ...
    // $('.tel-input').inputmask("+9(999)-999-99-99");
    $('.tel-input').inputmask({mask:"+79999999999", placeholder: "",});
});
...
let validateForm = function(selector, rules, index) {
...
if (document.querySelector('.form-call')) {
    validateForm('.form-call', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}
if (document.querySelector('.form-get')) {
    validateForm('.form-get', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}
if (document.querySelector('.form-order')) {
    validateForm('.form-order', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}
if (document.querySelector('.form-bottom')) {
    validateForm('.form-bottom', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}
if (document.querySelector('.form-question')) {
    validateForm('.form-question', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}



if (document.querySelector('.form__item-popup')) {
    validateForm('.form__item-popup', {email: {required: true, email: true}, tel: {required: true}, req: {required: true}}, index=1);
}
